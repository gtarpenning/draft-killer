...
from .schemas import Bookmaker, BookmakerComparison, Event, Outcome, ParlayLegComparison, Sport
...
class OddsService:
    ...
    def find_sport_by_name(self, name: str) -> Sport | None:
    ...
    def _parse_parlay_leg(self, leg_text: str) -> dict[str, Any] | None:
    ...
    def _find_best_odds(self, bookmaker_odds: list[dict], bet_type: str) -> dict | None:
    ...
    def _find_worst_odds(self, bookmaker_odds: list[dict], bet_type: str) -> dict | None:
    ...
    def _calculate_odds_range(self, best: dict | None, worst: dict | None) -> float | None:
    ...
    def _find_best_odds_for_market(self, event: Event, market: str) -> dict[str, Any] | None:
