...
class ParlayAnalyzer(Model):
    ...
    @weave.op()
    async def predict(self, user_message: str, enriched_odds: Optional[Dict[str, Any]] = None) -> str:
        """
    ...
    @weave.op()
    async def stream_predict(self, user_message: str, enriched_odds: Optional[Dict[str, Any]] = None) -> AsyncGenerator[str, None]:
        """
